...
switch ($action) {
	...
	function doInsert(){
		...
		if ( $_POST['CATEGORY'] == "" ) {
			$messageStats = false;
			message("Todos los datos son requeridos","Error");
			...
			message("Nuevo [". $_POST['CATEGORY'] ."] creado satisfactoriamente!", "success");
			redirect("index.php");
	...
	function doEdit(){
		if(isset($_POST['save'])){
			...
			message("[". $_POST['CATEGORY'] ."] ha sido actualizada!", "success");
			redirect("index.php");
		}
