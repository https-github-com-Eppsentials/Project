<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Lista de Productos  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Nuevo</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
			  ...
			  <tbody>
				...
				<div class="btn-group">
				  ...
				  <button type="submit" class="btn btn-default" name="delete"><i class="fa fa-trash fw-fa"></i> Eliminar Seleccionados</button>
				</div>
				</div>
				</form>
